...
local Tab2 = Window:MakeTab({"script Bay", "apple"})
...
local Tab3 = Window:MakeTab({"brainrot", ""})

local Section = Tab3:AddSection({"brainrot"})

Tab3:AddButton({
    Name = "copolo brainrot",
    Description = "",
    Default = false,
    Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/PainRoblox/Pain-na/refs/heads/main/brainrot.lua"))(Settings)
    end
})

local Tab4= Window:MakeTab({"cài đặt", "settings"})

local Section = Tab4:AddSection({"Blox fruit"})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/PainRoblox/Attack-/refs/heads/main/Fast%20Attack.txt"))()
